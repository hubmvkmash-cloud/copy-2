...
const FAQ = () => {
  return (
    <section id="questions" className="pb-[53px]">
      <div className="section">
        <div className="flex flex-col 1xl:flex-row 1xl:justify-start 1xl:gap-24 4xl:gap-55">
          ...
          {/*Right: list */}
          <ul className="flex flex-col w-full gap-[9px] lg:gap-10.5 1xl:gap-14.5 mb-15.5 xs:mb-25 1xl:mb-19 3xl:mb-10 4xl:mb-20  1xl:max-w-[902px] 3xl:max-w-[1156px] 4xl:max-w-[1486px]">
