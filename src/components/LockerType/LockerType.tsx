      ...
      <div className="section flex flex-col 1xl:flex-row 1xl:flex-wrap gap-18 1xl:gap-35">
        <div className="3xl:pl-69 4xl:pl-94 flex flex-col gap-[60px] lg:gap-[60px]">
          <div className="flex flex-col gap-10">
            <div className="">
              <h2 className="mb-6 1xl:mb-17 4xl:mb-15 text-center 1xl:text-left font-second font-medium">
                Технічні характеристики
              </h2>
            </div>

            <div className="flex flex-row-reverse items-center gap-10 justify-between max-[1023px]:flex-col max-[1439px]:items-start">
