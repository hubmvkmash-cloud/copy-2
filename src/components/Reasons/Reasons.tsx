const Reasons = () => {
  return (
    <section id="reasons" className="pb-40 1xl:pb-55 3xl:pb-60 4xl:pb-70">
      <div className="section flex flex-col 1xl:flex-row-reverse gap-[12px] 4xl:justify-end">
          ...
          <ul className="grid grid-cols-1 lg:flex flex-wrap 1xl:grid-cols-2 gap-21.5 1xl:gap-x-6.5 4xl:gap-x-32.5 1xl:gap-y-23.5 3xl:gap-y-21.5">
            <li className="border-t border-t-tuatara/75 pt-4.5 1xl:pt-10 lg:max-w-[420px] 3xl:max-w-[558px] 4xl:max-w-[620px]">
              ...
              <p className="text-[22px]/[114%] xs:text-[28px]/[114%] font-bold text-mercury-white mb-6.5">
                ...
                <br /> РОЗМІЩЕННЯ НА КРАЩИХ ЛОКАЦІЯХ
              </p>
              <p className="text-xl/[110%] text-boulder-dust 3xl:max-w-[520px] sm:mb-0 mb-[-3px]">
                Ми надаємо місце у найкращих локаціях із найбільшим трафіком. Серед таких: залізничні та автовокзали, автозаправки, торговельні та бізнес центри.
              </p>
            </li>
            <li className="border-t border-t-tuatara/75 pt-4.5 1xl:pt-10 lg:max-w-[420px] 3xl:max-w-[558px] 4xl:max-w-[620px] mt-[-4px] lg:mt-0">
              <div className="text-white/40 text-sm/2.5 flex gap-1 mb-4.5 1xl:mb-8.5">
                <p>Причина </p>
                <p>(02)</p>
              </div>
              <p className="text-[22px]/[114%] xs:text-[28px]/[114%] font-bold text-mercury-white mb-6.5">
                <span className="text-tangerine capitalize">ПОВНЕ</span> ЗАБЕЗ��ЕЧЕННЯ РОБОТИ СИСТЕМИ
              </p>
              <p className="text-xl/[110%] text-boulder-dust 3xl:max-w-[520px]">
                Ми забезпечуємо весь життєвий цикл системи: виготовлення обладнання, монтаж та подальше технічне обслуговування.<br />Ви завантажуєте авторські композиції та сувеніри, контролюєте реалізацію та отримуєте прибуток.
              </p>
            </li>
            <li className="border-t border-t-tuatara/75 pt-4.5 1xl:pt-10 lg:max-w-[420px] 3xl:max-w-[558px] 4xl:max-w-[620px] mt-[-4px] lg:mt-0">
              <div className="text-white/40 text-sm/2.5 flex gap-1 mb-4.5 1xl:mb-8.5">
              ...
              <p className="text-[22px]/[114%] xs:text-[28px]/[114%] font-bold text-mercury-white mb-6.5">
                <span className="text-tangerine capitalize">РОЗШИРЕННЯ</span> БІЗНЕСУ
              </p>
              <p className="text-xl/[110%] text-boulder-dust 3xl:max-w-[520px]">
                Наша система відкриває для інвестора нові го��изонти: завдяки модульній архітектурі, ви можете легко розширити бізнес, додати Тортомат, вендинговий апарат із сувенірами та інші інноваційні рішення, збільшуючи прибуток та охват аудиторії без додаткових витрат.
              </p>
            </li>
          </ul>
        </div>
